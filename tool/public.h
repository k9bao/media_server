...
#undef SINT32_MAX
#define SINT32_MAX INT_MAX //LONG_MAX
#undef UINT32_MAX
#define UINT32_MAX UINT_MAX //ULONG_MAX
#undef SINT64_MAX
...
//LOG_WARNING.../usr/include/sys/syslog.h redefine
#define CHNSYS_LOG_ERROR(s) \
    if (pLog) {             \
        pLog->LOGError s;   \
    }
#define CHNSYS_LOG_WARNING(s) \
    if (pLog) {               \
        pLog->LOGWarning s;   \
    }
#define CHNSYS_LOG_INFO(s) \
    if (pLog) {            \
        pLog->LOGInfo s;   \
    }
#define CHNSYS_LOG_DEBUG(s) \
    if (pLog) {             \
        pLog->LOGDebug s;   \
    }
#define DEBUG_OUT(s)    \
...
#define MESSAGE_OUT(s)      \
    if (pLog) {             \
        pLog->MessageOut s; \
    }
#define PRINT_OUT(s) \
    { printf s; }
#define TITLE_OUT(n, s)      \
    if (n & COMMAND_DEBUG) { \
        printf s;            \
    }
///////////////////////////////////////////////////////////////////////////////
